...
func initializeRequest(stdin io.WriteCloser) {
	initialize := `{"id": 0, "jsonrpc": "2.0", "method": "initialize", "params":{"capabilities":null,"processId":%d,"rootPath":"/home/kurenaif/Desktop/tools/gopls","rootUri":"file:///home/kurenaif/Desktop/tools/gopls","trace":"off"}}`
